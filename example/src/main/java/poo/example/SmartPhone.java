...
public class SmartPhone extends Celular{
	...
	private String nfc;
	private float pixelesCamaraFrontal;
	...
	public SmartPhone(String marca, String modelo, String color, float pixelesCamara, float tamanioMemoriaRam,
			float tamaoDisco, String nfc, float pixelesCamaraFrontal) {
	...
	public float getPixelesCamaraFrontal() {
		return pixelesCamaraFrontal;
	}

	public void setPixelesCamaraFrontal(float pixelesCamaraFrontal) {
		this.pixelesCamaraFrontal = pixelesCamaraFrontal;
	}
